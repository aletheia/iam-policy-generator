...
export declare enum ELASTIC_FILE_SYSTEM {
...
export declare enum IOT_THINGS_GRAPH {
...
export declare enum SAVINGS_PLANS {
...
export declare enum SYSTEMS_MANAGER {
...
export declare enum MIGRATION_HUB {
...
export declare enum LAMBDA {
    ...
    GET_LAYER_VERSION_BY_ARN = "lambda:GetLayerVersionByArn",
...
export declare enum DATA_EXCHANGE {
...
export declare enum MACHINE_LEARNING {
...
export declare enum EVENTBRIDGE {
...
export declare enum RESOURCE_ACCESS_MANAGER {
...
export declare enum ELEMENTAL_MEDIACONNECT {
...
export declare enum LAKE_FORMATION {
...
export declare enum MOBILE_HUB {
...
export declare enum GLOBAL_ACCELERATOR {
...
export declare enum SERVERLESS_APPLICATION_REPOSITORY {
...
export declare enum CLOUD_DIRECTORY {
...
export declare enum ELEMENTAL_MEDIATAILOR {
...
export declare enum SECURITY_TOKEN_SERVICE {
...
export declare enum ELEMENTAL_MEDIAPACKAGE {
...
export declare enum MANAGED_APACHE_CASSANDRA_SERVICE {
...
export declare enum MARKETPLACE_METERING_SERVICE {
...
export declare enum MARKETPLACE_PROCUREMENT_SYSTEMS_INTEGRATION {
...
export declare enum MARKETPLACE_CATALOG {
...
export declare enum MARKETPLACE_IMAGE_BUILDING_SERVICE {
...
export declare enum MARKETPLACE_ENTITLEMENT_SERVICE {
...
export declare enum PRIVATE_MARKETPLACE {
...
export declare enum SUMERIAN {
    LOGIN = "sumerian:Login",
    VIEW_RELEASE = "sumerian:ViewRelease"
}
export declare enum AUTO_SCALING {
...
export declare enum COST_AND_USAGE_REPORT {
...
export declare enum ROUTE53_DOMAINS {
...
export declare enum IDENTITY_AND_ACCESS_MANAGEMENT {
...
export declare enum ROUTE_53_RESOLVER {
...
export declare enum IOT_ANALYTICS {
...
export declare enum PINPOINT_EMAIL_SERVICE {
...
export declare enum COST_EXPLORER_SERVICE {
...
export declare enum CLOUDWATCH_SYNTHETICS {
...
export declare enum ELASTIC_INFERENCE {
    CONNECT = "elastic-inference:Connect"
}
export declare enum DEEPLENS {
...
export declare enum RDS_DATA_API {
...
export declare enum SSO_DIRECTORY {
...
export declare enum TRUSTED_ADVISOR {
...
export declare enum SIMPLE_WORKFLOW_SERVICE {
...
export declare enum CERTIFICATE_MANAGER {
...
export declare enum ELASTIC_CONTAINER_SERVICE_FOR_KUBERNETES {
...
export declare enum FIREWALL_MANAGER {
...
export declare enum DIRECTORY_SERVICE {
...
export declare enum IOT_SITEWISE {
...
export declare enum CODESTAR_NOTIFICATIONS {
...
export declare enum FRAUD_DETECTOR {
    ...
    DELETE_RULE_VERSION = "frauddetector:DeleteRuleVersion",
    ...
    GET_PREDICTION = "frauddetector:GetPrediction",
    ...
    PUT_MODEL = "frauddetector:PutModel",
...
export declare enum KINESIS_FIREHOSE {
...
export declare enum MECHANICAL_TURK {
...
export declare enum STORAGE_GATEWAY {
...
export declare enum ELASTIC_MAPREDUCE {
...
export declare enum IOT_EVENTS {
...
export declare enum ELASTICSEARCH_SERVICE {
    ADD_TAGS = "es:AddTags",
...
export declare enum BUDGET_SERVICE {
    MODIFY_BUDGET = "budgets:ModifyBudget",
    VIEW_BUDGET = "budgets:ViewBudget"
}
export declare enum EVENTBRIDGE_SCHEMAS {
...
export declare enum NETWORK_MANAGER {
...
export declare enum COGNITO_IDENTITY {
...
export declare enum LICENSE_MANAGER {
...
export declare enum ALEXA_FOR_BUSINESS {
...
export declare enum CERTIFICATE_MANAGER_PRIVATE_CERTIFICATE_AUTHORITY {
...
export declare enum STEP_FUNCTIONS {
...
export declare enum MESSAGE_DELIVERY_SERVICE {
...
export declare enum IOT_GREENGRASS {
...
export declare enum MARKETPLACE_MANAGEMENT_PORTAL {
...
export declare enum MANAGED_BLOCKCHAIN {
...
export declare enum APPSTREAM_20 {
...
export declare enum QUICKSIGHT {
...
export declare enum WORKSPACES_APPLICATION_MANAGER {
    AUTHENTICATE_PACKAGER = "wam:AuthenticatePackager"
}
export declare enum DATA_LIFECYCLE_MANAGER {
...
export declare enum WELLARCHITECTED_TOOL {
...
export declare enum CONNECTOR_SERVICE {
...
export declare enum BACKUP_STORAGE {
    MOUNT_CAPSULE = "backup-storage:MountCapsule"
}
export declare enum COGNITO_SYNC {
...
export declare enum ELASTIC_TRANSCODER {
...
export declare enum PRICE_LIST {
...
export declare enum MOBILE_ANALYTICS {
...
export declare enum IOT_DEVICE_TESTER {
...
export declare enum DATABASE_MIGRATION_SERVICE {
...
export declare enum SESSION_MANAGER_MESSAGE_GATEWAY_SERVICE {
...
export declare enum IQ_PERMISSIONS {
    APPROVE_ACCESS_GRANT = "iq-permission:ApproveAccessGrant"
}
export declare enum ELEMENTAL_MEDIAPACKAGE_VOD {
...
export declare enum DEVICE_FARM {
...
export declare enum GROUND_STATION {
...
export declare enum CODE_SIGNING_FOR_FREERTOS {
...
export declare enum IQ {
    CREATE_PROJECT = "iq:CreateProject"
}
export declare enum MANAGE_API_GATEWAY {
...
export declare enum DATABASE_QUERY_METADATA_SERVICE {
...
export declare enum MANAGED_STREAMING_FOR_KAFKA {
...
export declare enum CODEGURU_REVIEWER {
...
export declare enum PINPOINT_SMS_AND_VOICE_SERVICE {
...
export declare enum EC2_AUTO_SCALING {
...
export declare enum SECRETS_MANAGER {
...
export declare enum APPLICATION_AUTO_SCALING {
...
export declare enum APP_MESH_PREVIEW {
...
export declare enum KINESIS_VIDEO_STREAMS {
...
export declare enum KEY_MANAGEMENT_SERVICE {
...
export declare enum IMPORT_EXPORT_DISK_SERVICE {
...
export declare enum DATA_PIPELINE {
...
export declare enum SERVER_MIGRATION_SERVICE {
...
export declare enum WORKMAIL_MESSAGE_FLOW {
    GET_RAW_MESSAGE_CONTENT = "workmailmessageflow:GetRawMessageContent"
}
export declare enum CHATBOT {
...
export declare enum HEALTH_APIS_AND_NOTIFICATIONS {
...
export declare enum OPSWORKS_CONFIGURATION_MANAGEMENT {
...
export declare enum EC2_INSTANCE_CONNECT {
    SEND_SSH_PUBLIC_KEY = "ec2-instance-connect:SendSSHPublicKey"
}
export declare enum RDS_IAM_AUTHENTICATION {
    CONNECT = "rds-db:connect"
}
export declare enum APPLICATION_DISCOVERY {
...
export declare enum ELASTIC_BLOCK_STORE {
...
export declare enum CODEGURU_PROFILER {
    ...
    GET_FINDINGS_REPORT = "codeguru-profiler:GetFindingsReport",
...
export declare enum COGNITO_USER_POOLS {
...
export declare enum ELASTIC_BEANSTALK {
...
export declare enum CLOUDWATCH_APPLICATION_INSIGHTS {
...
export declare enum ELASTIC_LOAD_BALANCING_V2 {
...
export declare enum ELASTIC_LOAD_BALANCING {
    ADD_TAGS = "elasticloadbalancing:AddTags",
...
export declare enum WAF_REGIONAL {
...
export declare enum ELASTIC_CONTAINER_SERVICE {
...
export declare enum ELASTIC_CONTAINER_REGISTRY {
...
export declare enum DYNAMODB_ACCELERATOR_DAX {
...
export declare enum RESOURCE_GROUP_TAGGING_API {
...
export declare enum CLOUDWATCH_LOGS {
...
export declare enum SERVICE_CATALOG {
...
export declare enum PERSONALIZE {
...
export declare enum TRANSFER_FOR_SFTP {
...
export declare enum IAM_ACCESS_ANALYZER {
...
export declare enum APPLICATION_DISCOVERY_ARSENAL {
    REGISTER_ON_PREMISES_AGENT = "arsenal:RegisterOnPremisesAgent"
}
export declare enum GROUNDTRUTH_LABELING {
...
export declare enum ELEMENTAL_MEDIASTORE {
...
export declare enum IOT_1CLICK {
...
export declare enum SECURITY_HUB {
...
export declare enum EC2_IMAGE_BUILDER {
...
export declare enum COMPUTE_OPTIMIZER {
...
export declare enum LAUNCH_WIZARD {
...
export declare enum ELEMENTAL_MEDIACONVERT {
...
export declare enum SERVICE_QUOTAS {
...
export declare enum DIRECT_CONNECT {
...
export declare enum NEPTUNE {
    CONNECT = "neptune-db:connect"
}
export declare enum DATASYNC {
...
export declare enum KINESIS_ANALYTICS {
    ADD_APPLICATION_INPUT = "kinesisanalytics:AddApplicationInput",
    ADD_APPLICATION_OUTPUT = "kinesisanalytics:AddApplicationOutput",
    ADD_APPLICATION_REFERENCE_DATA_SOURCE = "kinesisanalytics:AddApplicationReferenceDataSource",
    CREATE_APPLICATION = "kinesisanalytics:CreateApplication",
