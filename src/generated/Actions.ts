...
export enum FLEET_HUB_FOR_IOT_DEVICE_MANAGEMENT {
  CREATE_APPLICATION = 'iotfleethub:CreateApplication',
  CREATE_DASHBOARD = 'iotfleethub:CreateDashboard',
  DELETE_APPLICATION = 'iotfleethub:DeleteApplication',
  DELETE_DASHBOARD = 'iotfleethub:DeleteDashboard',
  DESCRIBE_APPLICATION = 'iotfleethub:DescribeApplication',
  DESCRIBE_DASHBOARD = 'iotfleethub:DescribeDashboard',
  LIST_APPLICATIONS = 'iotfleethub:ListApplications',
  LIST_DASHBOARDS = 'iotfleethub:ListDashboards',
  ...
  UPDATE_DASHBOARD = 'iotfleethub:UpdateDashboard',
}
...
export enum IOT_CORE_DEVICE_ADVISOR {
  ...
  LIST_TEST_CASES = 'iotdeviceadvisor:ListTestCases',
